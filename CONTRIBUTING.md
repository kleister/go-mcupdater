...
If unique, [open an issue](https://github.com/kleister/go-mcupdater/issues) and answer the questions so we can understand and reproduce the problematic behavior.
